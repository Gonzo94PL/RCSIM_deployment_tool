      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-800 shadow-xl space-y-4">
          ...
          <p className="text-xs text-slate-400 leading-relaxed font-sans">
            {t('lang_en') === 'English' ? 'Switch vehicle dynamics and traction control profile.' : 'Przełącz profil dynamiki i kontroli trakcji pojazdu.'}
          </p>
        ...
        <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-800 shadow-xl space-y-4">
          ...
          <p className="text-xs text-slate-400 leading-relaxed font-sans">
            {t('lang_en') === 'English' ? 'Lock current throttle value or adjust speed automatically.' : 'Zablokuj aktualny poziom gazu lub dostosuj automatyczną prędkość.'}
          </p>
          ...
          <div className="flex items-center justify-between p-3 bg-slate-950/40 border border-slate-850 rounded-xl">
            ...
            >
              {cruiseActive ? (t('lang_en') === 'English' ? 'Active' : 'Aktywny') : (t('lang_en') === 'English' ? 'Enable' : 'Włącz')}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-800 shadow-xl font-sans">
        ...
        {selectedDiagPath && deviceState && (
          <div className="mt-6 p-5 bg-slate-950/65 rounded-xl border border-slate-800 space-y-6" id="controller-live-diagnostics">
            ...
            {/* Buttons grid */}
            <div className="space-y-3">
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">{t('col_reverse')} / Buttons</span>
